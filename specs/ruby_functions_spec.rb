...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_cube()
    vol_result = vol_of_cube(2,3,4)
    assert_equal(24, vol_result)
  end
  ...
  # add test code here
  def test_volume_of_sphere()
    vol_result = vol_of_sphere(5)
    assert_equal(523.33, vol_result)
  end
  # end
  #
  ...
  def test_fahrenheit_to_celsius()
    celsius_result = fahr_to_celsius(25)
    assert_equal(77, celsius_result)
  end
  #   #add test code here
  # end
